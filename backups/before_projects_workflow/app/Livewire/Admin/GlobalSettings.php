...
class GlobalSettings extends Component
{
    ...
    // Directory Welcome Settings
    public $directory_welcome_video_url;
    public $directory_welcome_message;
    ...
    public function loadSettings()
    {
        ...
        $this->directory_welcome_video_url = $settings['directory_welcome_video_url'] ?? '';
        $this->directory_welcome_message = $settings['directory_welcome_message'] ?? 'Bienvenido al Directorio Público de Abogados. Configura tu perfil para empezar.';
    ...
    public function save()
    {
        $data = [
            ...
            'directory_welcome_video_url' => $this->directory_welcome_video_url,
            'directory_welcome_message' => $this->directory_welcome_message,
        ];
