...
<body class="antialiased">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    <a href="{{ route('directory.public') }}" class="text-indigo-600 font-bold hover:text-indigo-800 transition flex items-center">
                    ...
                    <a href="{{ route('features') }}" class="text-gray-700 hover:text-indigo-600 transition">Características</a>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white p-8 rounded-2xl shadow-sm">
                    ...
                    <p class="text-gray-700 mb-4">"Diogenes transformó completamente la forma en que gestionamos nuestro despacho. Ahora todo está organizado y accesible desde cualquier lugar."</p>
    ...
    <section class="gradient-bg py-20 px-4">
        <div class="max-w-4xl mx-auto text-center text-white">
            ...
            <p class="text-xl mb-8 opacity-90">Únete a cientos de abogados que ya confían en Diogenes</p>
        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('features') }}" class="hover:text-white transition">Características</a></li>
