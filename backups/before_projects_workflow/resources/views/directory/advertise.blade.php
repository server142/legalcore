                ...
                <div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl overflow-hidden border-2 border-indigo-500 transform scale-105 z-10">
                        ...
                        <div class="p-8 text-center h-full flex flex-col">
                            ...
                            <div class="mt-8">
                                <a href="/register?plan=directory-only" class="block w-full bg-indigo-600 border border-transparent rounded-lg py-3 px-6 text-base font-bold text-white hover:bg-indigo-700 shadow-md transition-all">
                                    Destacar mi Perfil
                                </a>
                            </div>
                        </div>
