            ...
            <div class="md:col-span-2" x-data="{ tab: 'stripe' }" @set-tab.window="tab = $event.detail">
                <form wire:submit.prevent="save">
                    ...
                    <div x-show="tab === 'onboarding'" class="bg-white rounded-lg shadow p-6 space-y-4" style="display: none;">
                        <h3 class="text-lg font-bold text-gray-800 border-b pb-2">Configuración de Bienvenida (Onboarding General)</h3>
                        <p class="text-sm text-gray-500 mb-4">Se muestra a los usuarios con acceso completo a la Suite Diogenes.</p>
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                            ...
                            <div>
                                <x-input-label for="welcome_video_url" value="URL del Video de Bienvenida (Suite Completa)" />
                        ...
                        <h3 class="text-lg font-bold text-gray-800 border-b pb-2 mt-8">Configuración de Bienvenida (Directorio Exclusivo)</h3>
                        <p class="text-sm text-gray-500 mb-4">Se muestra a los usuarios que SOLO compraron el plan de Directorio.</p>
                        <div class="grid grid-cols-1 gap-4">
                            <div>
                                <x-input-label for="directory_welcome_video_url" value="URL del Video de Bienvenida (Directorio)" />
                                <x-text-input wire:model="directory_welcome_video_url" id="directory_welcome_video_url" class="mt-1 block w-full" type="text" placeholder="https://www.youtube.com/watch?v=..." />
                                <p class="text-xs text-gray-500 mt-1">Video explicando cómo configurar el perfil público.</p>
                            </div>
                            <div>
                                <x-input-label for="directory_welcome_message" value="Mensaje de Bienvenida (Directorio)" />
                                <textarea wire:model="directory_welcome_message" id="directory_welcome_message" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"></textarea>
                            </div>
                        </div>
                    </div>
