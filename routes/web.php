...
// Landings Campañas
Route::get('/landing-asesorias', \App\Livewire\Landings\BJCA\April2026Landing::class)->name('landings.bjca.april2026');
    ...
    */
    ...
    Route::get('/admin/roles', \App\Livewire\Admin\Roles\Index::class)->name('admin.roles.index')->middleware(['can:manage users', 'role:super_admin']);
    ...
    Route::get('/admin/api-settings', \App\Livewire\Admin\ApiSettings::class)->name('admin.api-settings')->middleware('can:manage settings');
