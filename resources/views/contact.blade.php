        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    ...
                    <a href="{{ route('welcome') }}#testimonials" class="text-gray-700 hover:text-indigo-600 transition">Testimonios</a>
                </div>
            ...
            <div class="space-y-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <a href="https://wa.me/522281405060" target="_blank" class="text-indigo-600 font-semibold hover:underline">Iniciar chat &rarr;</a>
                    </div>
                </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100 flex items-start space-x-4">
                    ...
                    <div>
                        ...
                        <a href="mailto:soporte@legalcore.mx" class="text-indigo-600 font-semibold hover:underline">soporte@diogenes.mx</a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                ...
                <form action="#" method="POST" class="space-y-4">
                    <div>
                        ...
                        <input type="text" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Juan Pérez">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Correo Electrónico</label>
                        <input type="email" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="juan@ejemplo.com">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <textarea rows="4" class="w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Escribe tu mensaje aquí..."></textarea>
                    </div>
                    <button type="button" onclick="alert('Gracias por tu mensaje. Te contactaremos pronto.')" class="w-full bg-indigo-600 text-white py-3 rounded-lg font-bold hover:bg-indigo-700 transition">Enviar Mensaje</button>
                </form>
            </div>
        </div>
    </section>
