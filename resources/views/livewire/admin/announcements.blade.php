                    ...
                    <form wire:submit.prevent="send" class="space-y-6">
                        ...
                        <div class="flex justify-end pt-4">
                            <button type="submit" 
                                    ...
                                    class="group relative inline-flex items-center justify-center px-8 py-3 font-semibold text-white transition-all bg-indigo-600 rounded-xl hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-600">
