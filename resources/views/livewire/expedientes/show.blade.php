    ...
    <div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4" wire:key="show-header">
        ...
        <div class="flex flex-wrap gap-2 w-full md:w-auto" wire:key="header-actions">
            ...
            <div class="relative" x-data="{ open: false }" @click.outside="open = false">
                <button @click="open = !open" type="button" class="bg-white border border-gray-300 text-gray-700 px-3 py-2 rounded-lg hover:bg-gray-50 flex items-center justify-center flex-1 md:flex-none text-sm transition shadow-sm whitespace-nowrap">
                    ...
                    Contrato
                    <svg class="w-3 h-3 ml-1.5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
                </button>
                ...
                <div x-show="open" 
                     ...
                     class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-xl z-50 border border-gray-100 py-1" 
                     style="display: none;">
                    
                    <a href="{{ route('expedientes.contract', $expediente) }}" target="_blank" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-indigo-600 flex items-center group">
                        <svg class="w-4 h-4 mr-2 text-red-500 group-hover:text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                        Ver PDF
                    </a>
                    
                    <a href="{{ route('expedientes.contract', ['expediente' => $expediente, 'format' => 'word']) }}" target="_blank" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 hover:text-indigo-600 flex items-center group border-t border-gray-100">
                        <svg class="w-4 h-4 mr-2 text-blue-600 group-hover:text-blue-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        Descargar Word
                    </a>
                </div>
            </div>
            ...
            <form wire:submit.prevent="update" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <x-text-input id="numero" type="text" class="mt-1 block w-full" wire:model="numero" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="titulo" type="text" class="mt-1 block w-full" wire:model="titulo" required />
                    ...
                    <div>
                        ...
                        <select id="abogado_responsable_id" wire:model="abogado_responsable_id" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                            <option value="">-- Seleccionar --</option>
                    ...
                    <div>
                        ...
                        <x-text-input id="materia" list="materias-list" type="text" class="mt-1 block w-full" wire:model="materia" required />
                    ...
                    <!-- Juzgado -->
                    <div>
                        <x-input-label for="juzgado" :value="__('Juzgado / Instancia')" />
                        <x-text-input id="juzgado" list="juzgados-list" type="text" class="mt-1 block w-full" wire:model="juzgado" />
                        <datalist id="juzgados-list">
                    ...
                    <div>
                        ...
                        <select id="estado_procesal_id" wire:model="estado_procesal_id" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                            <option value="">-- Manual (Usar texto actual) --</option>
                            @foreach($estadosProcesales as $ep)
                                <option value="{{ $ep->id }}">{{ $ep->nombre }}</option>
                            @endforeach
                        </select>
                        <p class="text-xs text-gray-500 mt-1">Actual: {{ $estado_procesal }}</p>
                    ...
                    <div>
                        ...
                        <x-text-input id="nombre_juez" type="text" class="mt-1 block w-full" wire:model="nombre_juez" />
                    </div>
                ...
                <div class="flex justify-end pt-4 gap-2">
                    <button type="button" wire:click="$set('showEditModal', false)" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 text-sm font-medium">
                        Cancelar
                    </button>
                    <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm font-bold">
                        Guardar Cambios
                    </button>
                </div>
            </form>
